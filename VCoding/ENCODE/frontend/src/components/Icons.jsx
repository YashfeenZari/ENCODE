/** Professional inline SVG icons for feature cards */
...
/** Academy: stats & feature icons */
export function IconUsers(props) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...props}>
...
export function IconBookmarkFilled(props) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...props}>
      <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
    </svg>
  )
}
...
export function IconInfinity(props) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden {...props}>
      <path d="M12 12c-2.5 2.5-5 4-8 4s-4-1.5-4-4 1.5-4 4-4 5.5 1.5 8 4 5.5 4 8 4 4-1.5 4-4-1.5-4-4-4-5.5 1.5-8 4z" />
    </svg>
  )
}
